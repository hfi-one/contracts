...
contract StrategyHBOSingle {
    ...
    address public pool = 0x0f1228dFB46a92825858Ec417Db7FB3b542C1DF8;
    address public want = HBO;
    ...
    function harvest() public onlyBenevolent {
        ...
        if (_hbo > 0) {
            ...
            path[0] = want;
            path[1] = usdt;
            Uni(uniRouter).swapExactTokensForTokens(_reward, uint256(0), path, address(this), block.timestamp.add(1800));

            IERC20(usdt).safeTransfer(IController(controller).rewards(), IERC20(usdt).balanceOf(address(this)));
        }
        deposit();
    }
